    ...
    return (
      ...
      >
        <View className="flex-1 justify-center px-6 py-12">
          ...
          {resetMessage ? (
            <Text className="text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3 mb-4">
              {resetMessage}
            </Text>
          ) : null}
          ...
          {resetStep === "email" && (
            <>
              ...
              <TouchableOpacity
                ...
                className="w-full bg-emerald-600 py-4 rounded-xl items-center mb-3"
              >
                {resetLoading ? (
